...
const Search = () => {
    ...
    useEffect(() => {
        ...
        const categotyFromUrl = urlParams.get('category');
        if (searchTermFromUrl || sortFromUrl || categotyFromUrl) {
            setSideBarData({
                ...sideBarData,
                searchTerm: searchTermFromUrl,
                sort: sortFromUrl,
                category: categotyFromUrl
            })
        }
        ...
        <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full">
                ...
                <div className="p-7 flex flex-wrap gap-4">
                    {
                        !loading && posts.length === 0 && <p className='text-lg text-gray-500'>
                            No posts found.
                        </p>
                    }
                    {loading && (
